...
export const SEED_USERS: { id: string; name: string; prefs: UserPrefs }[] = [
  {
    id: "u_ines", name: "Ines",
    prefs: {
      archetype: "auto", scheme: "auto", vibe: "auto", budget: null, categories: ["table", "brew"],
      need: "想找能用很久、有故事的東西",
  ...
  },
  {
    id: "u_leo", name: "Leo",
    prefs: {
      archetype: "auto", scheme: "auto", vibe: "auto", budget: null, categories: ["carry", "home"],
      need: "週末要去露營,想帶點不一樣的",
  ...
  },
  {
    id: "u_ada", name: "Ada",
    prefs: {
      archetype: "auto", scheme: "auto", vibe: "auto", budget: null, categories: ["paper"],
      need: "比較規格再決定,不喜歡廣告感",
  ...
  },
  {
    id: "u_ken", name: "Ken",
    prefs: {
      archetype: "auto", scheme: "auto", vibe: "auto", budget: 1500, categories: [],
  ...
  },
  {
    ...
    id: "u_new", name: "你",
    prefs: { archetype: "auto", scheme: "auto", vibe: "auto", budget: null, categories: [], need: "", persona: { ...EMPTY_PERSONA } },
  },
];
